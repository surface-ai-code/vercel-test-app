        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-pink-500 via-orange-400 to-blue-500 min-h-[90vh] flex items-center">
          ...
          <div className="container mx-auto px-4 py-12 md:py-20">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              {/* Hero Content */}
              <div id="hero-content-container" className="text-white space-y-6 z-10">
                ...
                <h1 id="hero-headline" className="text-5xl md:text-7xl font-bold leading-tight text-balance drop-shadow-lg">
                  Sweeten Your Day with Pure Joy
                </h1>

                <p id="hero-subtext" className="text-xl md:text-2xl text-white leading-relaxed text-pretty drop-shadow-md font-medium">
              ...
              {/* Hero Image */}
              <div id="hero-img-container" className="relative z-10">
